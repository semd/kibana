...
export declare const headerButtonBaseStyles: import("@emotion/react").SerializedStyles;
export declare const headerButtonBorderedStyles: import("@emotion/react").SerializedStyles;
