...
/**
 * The single source of truth for which proposal categories map to which graph
 * panels and what colour each panel uses. `escalate` is intentionally omitted
 * until a design decision is made about where it belongs.
 */
