...
describe('ProductFeaturesService', () => {
  ...
  it.only('should create ProductFeatureService instance', () => {
    new ProductFeaturesService(loggerMock.create(), config);
  ...
  //   const productFeaturesService = new ProductFeaturesService(loggerMock.create(), config);

  //   const featuresSetup = featuresPluginMock.createSetup();
  //   productFeaturesService.setup(featuresSetup);
  ...
  //     beforeEach(() => {
  //       productFeaturesService = new ProductFeaturesService(loggerMock.create(), config);
  //       productFeaturesService.registerApiAccessControl(mockHttpSetup);
